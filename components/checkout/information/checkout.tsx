  ...
  return (
    <>
      <section className="flex flex-col-reverse items-start justify-between lg:flex-row lg:justify-between">
        <div className="w-full px-4 py-4 lg:w-1/2 xl:px-16">
          {isLoading ? (
            <CheckoutSkeleton />
          ) : (
            <Stepper
        ...
        <div className="h-full w-full justify-self-start border-0 border-l border-none border-black/[10%] dark:border-neutral-300 lg:w-1/2 lg:border-solid">
          {isLoading ? (
